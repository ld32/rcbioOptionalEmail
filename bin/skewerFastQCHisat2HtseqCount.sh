...
usage() { echo -e "\nUsage : $0 <-r species_index -a <adapter.fa> (required. Such as: mm10 or hg19. Let us know if you need other references)> "; exit 1;} 
...
module load gcc/6.2.0 skewer/0.2.2 fastqc/0.11.5 hisat2/2.0.5 samtools/1.3.1   python/2.7.12 htseq/0.9.1 R/3.4.1 
